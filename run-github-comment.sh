...
# This script runs github-comment directly without installing
#
set -e
usage() {
  this=$1
...
EMBEDDED_CHECKSUMS="
6.3.5:github-comment_6.3.5_darwin_amd64.tar.gz:ae36c77af8b341ec8a6acac83ba68641dcc933b3571de6f213f7970993ca88fa
6.3.5:github-comment_6.3.5_darwin_arm64.tar.gz:41824cdccbeccebec0a0acb3388a8951e1d7300f6c912c392d347ed76a0f02d0
6.3.5:github-comment_6.3.5_linux_amd64.tar.gz:2e5090cd77be1c8aece9390030a9c12b157e08535f757223ad2317ff7382a411
6.3.5:github-comment_6.3.5_linux_arm64.tar.gz:b74418dbd5da1d1fb257aa60d639c2011347b438909560910a8f52c4ae371aab
6.3.5:github-comment_6.3.5_windows_amd64.tar.gz:0dfebe1070116163a3e2cf8c8f3d52065653c9f439f3b38a75ec963ee15a650b
6.3.5:github-comment_6.3.5_windows_arm64.tar.gz:1122b7821be3b02e60ea26a6e542cef11cd287eb0b5cdb5a1bc214f6f84f0e79"
...
configure_from_env() {
  ...
  if [ -n "${BINSTALLER_TARGET_TAG}" ]; then
    log_crit "BINSTALLER_TARGET_TAG is set but this script is configured for v6.3.5 only"
...
resolve_asset_filename() {
  ...
  if [ -z "${ASSET_FILENAME}" ]; then
    ASSET_FILENAME="github-comment_${VERSION}_${OS}_${ARCH}${EXT}"
  fi
}
...
execute() {
  STRIP_COMPONENTS=0
  CHECKSUM_FILENAME="github-comment_${VERSION}_checksums.txt"
  ...
  BINARY_NAME='github-comment'
  if [ -z "${EXT}" ] || [ "${EXT}" = ".exe" ]; then
    BINARY_PATH="${TMPDIR}/${ASSET_FILENAME}"
  else
    BINARY_PATH="${TMPDIR}/github-comment"
  fi
